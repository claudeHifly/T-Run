...
public class Cactus extends Item {
     ...
     * combines up arrows with cactus to indicate the action that must be
     * performed by the character in order to avoid the obstacle.
     */
    public Cactus(int x, int y) {
        super(x, y, Resources.instance().getCactus());
        if (HomePage.demo) {
            Board.arrows.addArrowUp(x - distanceArrowCactus, (Ground.yPosition));
        }
    }
